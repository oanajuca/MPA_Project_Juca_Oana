...
namespace MPAProjectJucaOana.Migrations
{
    ...
    [Migration("20230109170943_migration7")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MPA_Project_Juca_Oana.Models.City", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MPA_Project_Juca_Oana.Models.StadiumByCity", b =>
                {
                    b.Property<int>("StadiumID")
                        .HasColumnType("int");
                    ...
                    b.ToTable("StadiumByCity", (string)null);
                });
            ...
            modelBuilder.Entity("MPA_Project_Juca_Oana.Models.StadiumByCity", b =>
                {
                    b.HasOne("MPA_Project_Juca_Oana.Models.City", "City")
                        .WithMany("StadiumByCity")
                        .HasForeignKey("CityID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MPA_Project_Juca_Oana.Models.Stadiums", "Stadium")
                        .WithMany("StadiumByCity")
